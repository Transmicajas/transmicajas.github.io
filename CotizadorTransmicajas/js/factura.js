const scriptURL =
  "https://script.google.com/macros/s/AKfycbys0ozEfHWBVTJInQ26xA57Kbj62aZcWeJwfTidpQuYvLVY2KMCalXP3b47r2WK4kXk/exec";
...
function renderTable(data) {
  ...
  data.forEach((row, index) => {
    ...
    tableRow.insertCell(6).textContent = row.preciov;
